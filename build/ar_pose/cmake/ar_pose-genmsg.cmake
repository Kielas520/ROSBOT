...
message(STATUS "ar_pose: 0 messages, 1 services")
...
get_filename_component(_filename "/home/reicom2025/ros_workspace/src/ar_pose/srv/Track.srv" NAME_WE)
add_custom_target(_ar_pose_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ar_pose" "/home/reicom2025/ros_workspace/src/ar_pose/srv/Track.srv" ""
)
...
_generate_srv_cpp(ar_pose
  "/home/reicom2025/ros_workspace/src/ar_pose/srv/Track.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ar_pose)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ar_pose\")")
  # install generated code
  install(
