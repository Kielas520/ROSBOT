...
get_filename_component(_filename "/home/reicom2025/ros_workspace/src/relative_move/srv/SetRelativeMove.srv" NAME_WE)
add_custom_target(_relative_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "relative_move" "/home/reicom2025/ros_workspace/src/relative_move/srv/SetRelativeMove.srv" "geometry_msgs/Pose2D"
)
...
_generate_srv_cpp(relative_move
  "/home/reicom2025/ros_workspace/src/relative_move/srv/SetRelativeMove.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/relative_move)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/relative_move\")")
  # install generated code
  install(
